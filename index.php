<?php
    ...
    $event_date_and_location = 'Wednesday, <span class="ho-main-clr">May 21st from 5:30 - 7:00 pm,</span> Fisk Hall, Room 217';
    $date_day = 'Wednesday';
    $date_short = '5/21';
    $end_date = 'June 14, 2014 ';
    $raffle_date_range = 'May 22 - June 14';


    // Form Links
    $sign_up_form_link = 'https://docs.google.com/forms/d/1_pBJi6lHnXsDjj2KVjIxNINsxLs3slBXwOTLa4JXNxU/viewform'; // EDIT
    // $sign_up_form_link = '';
    ...
    $ambassador_linkedin = 'http://www.linkedin.com/pub/christine-christie-wood/3a/115/379';
...
<!-- Profiles Section --------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="row-fluid">
            ...
            <div class="span4">
                ...
                <p>As our local trusty Google Helpouts Category Specialist, Morgane's helping <?php echo $school_full; ?> put on this awesome talk and raffle. Say "Hi, and thank you!" for all her hard work when you see her, and don't be afraid to bug her with questions! Alma Mater: McGill University, Montreal</p>
                <p> <a class="btn" href="http://goo.gl/qmzTTW">View details »</a></p>
            </div >
            <!-- /.span4 -->
            ...
            <div class = "span4" >
                ...
                <p> <a class="btn" href="http://goo.gl/E9XRBs"> View details »</a></p>
                </div>
            <!-- /.span4 -->
...
<!-- The Raffle Section -------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="featurette">
            ...
            <blockquote class="block-align-r block-media">
                <p class="block-quotage p-block-media">Sign your friends and family up for Helpouts and you'll have the chance to win VIP access to Google's Chicago office or a Chromecast!</p>
            </blockquote>
 ...
 <!--            <p class="lead">On <span class="ho-main-clr" style="color: red;">Friday, May 2</span>, SFSU students joined the ACM Club and Marketing Association for a "Start Your Career in Tech" talk sponsored by Google. Daniel Arnold shared his thoughts on innovating in today's tech landscape and what it's like to work with a startup model for Helpouts at Google. <a href="#myModal3" class="ho-main-clr" role="button" data-toggle="modal">Click here to the view images!</a></p> -->
            ...
            <p class="lead"><strong>Just follow these steps:</strong></p>
            <ol class="lead">
                <li><p>Sign up for Helpouts at <a href="http://collegehelpouts.com" class="ho-main-clr">collegehelpouts.com</a></p></li>
                <li>
                    ...
                    <ol class="alph" type="a">
                        <li><p class="marg-r">Your Helpout can be free or paid.If you pay for the Helpout, use this coupon code to get $25 off: <span class="ho-main-clr bold"><?php echo $coupon_code; ?></span> </p></li>
                        <li><p>Your Helpout needs to be at least 5 minutes long.</p></li>
                    </ol>
                </li>
                <li>
                    <p class="marg-r">Each screenshot you send us will submit your name once to the raffle.You can submit up to 10 screenshots of individual Helpout sessions.<span style="color: red;">*</span></p>
                </li>
                <div class="float-right"><img class="main-br img-media" src="<?php echo $example_img; ?>"><h4 class="media-ex ho-main-clr">Example Submission</h4></div>
                <li>
                    <p class="lil-marg-top">The Helpouts team will randomly pick <?php echo $number_of_drawings; ?> winners for the prizes above from all submissions on <?php echo $end_date; ?>, and <?php echo $sponsoring_org; ?> will post the winners here on the site!</p>
                </li>
            </ol>
